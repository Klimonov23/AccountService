...
import com.sdi.notificationservice.client.AccountServiceClient;
...
public class NotificationServiceImpl implements  NotificationService{
    ...
    public void sendBackupNotifications() {
        ...
        List<Recipient> recipientList=recipientService.findReadyToNotify(type);
        log.info("found {} recipients for backup notification", recipientList.size());

        recipientList.forEach(recipient -> CompletableFuture.runAsync(()->{
            try {
